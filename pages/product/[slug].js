...
const Slug = ({ addToCart, product, variants }) => {
  console.log(variants.color, product);
        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
            <img
              ...
              src="https://codeswear.nyc3.cdn.digitaloceanspaces.com/there's%20no%20place%20like%20white%20127.0.0.1.png"
            />
                  ...
                  {Object.keys(variants).includes("red") &&
                    Object.keys(variants["red"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-red-700 ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                  {Object.keys(variants).includes("blue") &&
                    Object.keys(variants["blue"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-blue-700 ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                  {Object.keys(variants).includes("black") &&
                    Object.keys(variants["black"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-black ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                  {Object.keys(variants).includes("green") &&
                    Object.keys(variants["green"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-green-700 ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                  {Object.keys(variants).includes("yellow") &&
                    Object.keys(variants["yellow"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-yellow-700 ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                  {Object.keys(variants).includes("purple") &&
                    Object.keys(variants["purple"]).includes(size) && (
                      <button
                        ...
                        className="border-2 bg-purple-700 ml-1 border-gray-300 rounded-full w-6 h-6 focus:outline-none"
                      ></button>
                    )}
                </div>
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {Object.keys(variants["red"]).includes("M") && (
